...
void initialize()
{
    ...
    I2C1_Write1ByteRegister(0x68,0x1B, 0);
    I2C1_Write1ByteRegister(0x68,0x1C, 0);
}

void autoConfigLowEnergy()
{
    I2C1_Write1ByteRegister(0x68,0x6B, 0b00101000);
    I2C1_Write1ByteRegister(0x68,0x6C, 0b00000111);
}
...
int16_t getAccelerationX() {
    return(I2C1_Read2ByteRegister(0x68, 0x3B));
}

int16_t getAccelerationY() {
    return(I2C1_Read2ByteRegister(0x68, 0x3D));
}

int16_t getAccelerationZ() {
    return(I2C1_Read2ByteRegister(0x68, 0x3F));
}
