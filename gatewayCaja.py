...
def on_connect(client, userdata, flags, rc):
	if rc == 0:
		print("MQTT connected OK Returned code = {}".format(rc))
	else:
...
def procCaja(fd,mosq, message):
	...
	print("\nTrama:",caja[cID],caja[secuencia],caja[bat],caja[reser1],caja[reser2],caja[dia],caja[puerta],caja[reser3])
